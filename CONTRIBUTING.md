...
[project page](https://github.com/melnyk/go-uuid)) for all related discussions.

If you want to find an area that currently needs improving have a look at the
open issues listed on the
[issues](https://github.com/melnyk/go-uuid/issues) page](https://github.com/melnyk/go-uuid/issues). This is also the place
...
(without having `$GOPATH` set) and `cd` into the directory:
    ...
    $ unset GOPATH
    $ git clone https://github.com/melnyk/go-uuid
    $ cd go-uuid
